            ...
            <div class="container-fluid">
                <div class="row mb-2 ml-1">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/product/add') }}" class="btn btn-primary"><i class="nav-icon fas fa-shopping-cart"></i><span> +</span></a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <a href="{{ url('admin/product/list') }}" class="btn" style="margin-left: -38px"><i class="fa fa-times"></i></a>
